...
local menu
do
    local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/Jayyy102/Universal/main/ui-library.lua"))()

    menu = library.new([[Purpleware.xyz <font color="rgb(78, 93, 234)">v0.1 Beta</font>]], "nemv2\\")
    local tabs = {
    ...
    do
        ...
        local unload = _menu.new_sector("Unload", "Right")
        unload.element("Button", "Unload", nil, function()
            library:Unload();
        end)
    ...
    do
        ...
        local autoclicker = aimbot.new_sector("Auto Clicker")
        autoclicker.element("Toggle", "enabled"):add_keybind()
        autoclicker.element("Slider", "Clicks Per Second", {default = {min = 1, max = 20, default = 1}})
